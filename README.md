...
> 🔗 **[coderix.ru](https://coderix.ru/)** — Мой самый большой и любимый проект, в который я вложил душу. Полностью задеплоен на VDS c использованием Nginx. Уникальные фичи: дизайн с нуля, собственная серверная часть, голова дракона, следящая за курсором (без ИИ), заявки в Telegram, админка, браузерная игра «Лопни шарики». → [Репозиторий](https://github.com/ngabibullaev/coderix.git)
