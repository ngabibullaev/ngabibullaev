...
> Уникальные фичи: дизайн с нуля, собственная серверная часть, голова дракона, следящая за курсором (без ИИ), заявки в Telegram, админка, браузерная игра «Лопни шарики». → [Репозиторий](https://github.com/ngabibullaev/coderix.git)
...
> 🔗 **[Мои первые проекты на React](https://test-projects-taupe.vercel.app/)** — Мои первые мини-проекты. Сам не знаю, зачем я их закрепил, но хочу, чтобы вы знали: этот код я писал 3 года назад, когда ИИ ещё не было :) → [Репозиторий](https://github.com/ngabibullaev/test-projects.git)
